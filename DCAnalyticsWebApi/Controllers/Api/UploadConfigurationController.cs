using DCAnalytics;
using DCAnalyticsWebApi.Providers;
...
{
    public class UploadConfigurationController : ApiController
    {
        ...
        private void DoSync(Configuration configuration)
        {
            ...
            else
            {
                ...
                Configuration serverConfiguration = DCAnalytics.Configuration.LoadJson(configString, jsonSettings);
