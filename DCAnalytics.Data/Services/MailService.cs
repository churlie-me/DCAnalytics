...
namespace DCAnalytics.Data.Services
{
    public class MailService
    {
        ...
        private static string MailBody(string innerHtml, string url)
        {
            try
            {
                string body = "<div style='background: #f5f4f4;padding: 100px;'>"
                            ...
                            + "         <h1 style='margin: auto; text-align: center; color: #fff'> DCAnalytics </h1>"
                            + "     </div>"
                            ...
                            + "         Have questions or need help? Email <a href='#'> support@DCAnalyticsapp.com </a> or call 0414672152"
                            + "     </div>"
        ...
        public async static Task SendMail(string recipient, bool IsHtml, string Subject, string innerHtml, string url = null)
        {
            try
            {
                ...
                var from = new EmailAddress(Email, "DCAnalytics");
                var subject = Subject;
