...
namespace DCAnalytics
{
    ...
    [DataContract]
    public class EnumList : DCAnalyticsObject
    {
        [DataMember]
        ...
        public new DCAnalyticsObject Parent
        {
            get
            {
                return base.Parent as DCAnalyticsObject;
            }
        }
        public EnumList(DCAnalyticsObject parent) : base(parent)
        {
