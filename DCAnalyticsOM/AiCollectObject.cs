...
{
    public abstract class DCAnalyticsObject
    {
        [Browsable(false)]
        public Configuration Configuration { get; set; }
        [Browsable(false)]
        public DCAnalyticsObject Parent { get; private set; }
        ...
        internal DCAnalyticsObject Copy()
        {
            return (DCAnalyticsObject)this.MemberwiseClone();
        }

        public DCAnalyticsObject Clone()
        {
            return (DCAnalyticsObject)this.MemberwiseClone();
        }
