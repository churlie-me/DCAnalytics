...
{
    [DataContract]
    public class Questionaires : DCAnalyticsObject, ICollection<Questionaire>, IEnumerable<Questionaire>,IComparable<Questionaires>
    {

        private List<Questionaire> _questionaires;

        public Questionaires(DCAnalyticsObject parent) : base(parent)
        {
